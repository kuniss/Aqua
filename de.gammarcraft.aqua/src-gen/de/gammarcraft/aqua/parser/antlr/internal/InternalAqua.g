...
entryRuleAquaModel returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getAquaModelRule()); }
	 iv_ruleAquaModel=ruleAquaModel 
	 { $current=$iv_ruleAquaModel.current; } 
	 EOF 
;

// Rule AquaModel
ruleAquaModel returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
...
(
    ...
    { 
        $current = $this_UnitOrBoard_0.current; 
        afterParserOrEnumRuleCall();
    }
...
entryRuleUnitOrBoard returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getUnitOrBoardRule()); }
	 iv_ruleUnitOrBoard=ruleUnitOrBoard 
	 { $current=$iv_ruleUnitOrBoard.current; } 
	 EOF 
;

// Rule UnitOrBoard
ruleUnitOrBoard returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
...
entryRuleOutputPortReference returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getOutputPortReferenceRule()); }
	 iv_ruleOutputPortReference=ruleOutputPortReference 
	 { $current=$iv_ruleOutputPortReference.current; } 
	 EOF 
;

// Rule OutputPortReference
ruleOutputPortReference returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
    ...
    { 
        $current = $this_LocalInputPort_0.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_IntegratedPort_1.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
entryRuleIntegratedPort returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getIntegratedPortRule()); }
	 iv_ruleIntegratedPort=ruleIntegratedPort 
	 { $current=$iv_ruleIntegratedPort.current; } 
	 EOF 
;

// Rule IntegratedPort
ruleIntegratedPort returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
entryRuleLocalInputPort returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getLocalInputPortRule()); }
	 iv_ruleLocalInputPort=ruleLocalInputPort 
	 { $current=$iv_ruleLocalInputPort.current; } 
	 EOF 
;

// Rule LocalInputPort
ruleLocalInputPort returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0=':' 
...
entryRuleInputPortReference returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getInputPortReferenceRule()); }
	 iv_ruleInputPortReference=ruleInputPortReference 
	 { $current=$iv_ruleInputPortReference.current; } 
	 EOF 
;

// Rule InputPortReference
ruleInputPortReference returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
    ...
    { 
        $current = $this_LocalOutputPort_0.current; 
        afterParserOrEnumRuleCall();
    }
...
entryRuleLocalOutputPort returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getLocalOutputPortRule()); }
	 iv_ruleLocalOutputPort=ruleLocalOutputPort 
	 { $current=$iv_ruleLocalOutputPort.current; } 
	 EOF 
;

// Rule LocalOutputPort
ruleLocalOutputPort returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0=':' 
...
(
    ...
    { 
        $current = $this_InputProcessingDeclaration_1.current; 
        afterParserOrEnumRuleCall();
    }
...
entryRuleInputProcessingDeclaration returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getInputProcessingDeclarationRule()); }
	 ...
	 { $current=$iv_ruleInputProcessingDeclaration.current; } 
	 EOF 
;

// Rule InputProcessingDeclaration
ruleInputProcessingDeclaration returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='on' 
