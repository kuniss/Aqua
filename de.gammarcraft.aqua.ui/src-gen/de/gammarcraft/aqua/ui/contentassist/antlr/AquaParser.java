...
* generated by Xtext
*/
package de.gammarcraft.aqua.ui.contentassist.antlr;
...
public class AquaParser extends AbstractContentAssistParser {
	...
	@Override
	protected de.gammarcraft.aqua.ui.contentassist.antlr.internal.InternalAquaParser createParser() {
		de.gammarcraft.aqua.ui.contentassist.antlr.internal.InternalAquaParser result = new de.gammarcraft.aqua.ui.contentassist.antlr.internal.InternalAquaParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getUnitOrBoardAccess().getAlternatives(), "rule__UnitOrBoard__Alternatives");
					put(grammarAccess.getPortDeclarationAccess().getAlternatives(), "rule__PortDeclaration__Alternatives");
					put(grammarAccess.getOutputPortAccess().getAlternatives_0(), "rule__OutputPort__Alternatives_0");
					put(grammarAccess.getOutputPortReferenceAccess().getAlternatives(), "rule__OutputPortReference__Alternatives");
					put(grammarAccess.getInputPortReferenceAccess().getAlternatives(), "rule__InputPortReference__Alternatives");
					...
					put(grammarAccess.getAquaModelAccess().getGroup(), "rule__AquaModel__Group__0");
					...
					put(grammarAccess.getIntegratedPortAccess().getGroup(), "rule__IntegratedPort__Group__0");
					put(grammarAccess.getPortAccess().getGroup(), "rule__Port__Group__0");
					put(grammarAccess.getLocalInputPortAccess().getGroup(), "rule__LocalInputPort__Group__0");
					put(grammarAccess.getLocalOutputPortAccess().getGroup(), "rule__LocalOutputPort__Group__0");
					...
					put(grammarAccess.getInputProcessingDeclarationAccess().getGroup(), "rule__InputProcessingDeclaration__Group__0");
					put(grammarAccess.getInputProcessingDeclarationAccess().getGroup_3(), "rule__InputProcessingDeclaration__Group_3__0");
					...
					put(grammarAccess.getXExpressionAccess().getGroup_1_0(), "rule__XExpression__Group_1_0__0");
					...
					put(grammarAccess.getAquaModelAccess().getImportSectionAssignment_1(), "rule__AquaModel__ImportSectionAssignment_1");
					put(grammarAccess.getAquaModelAccess().getTypesAssignment_2(), "rule__AquaModel__TypesAssignment_2");
					...
					put(grammarAccess.getBoardAccess().getPortsAssignment_2(), "rule__Board__PortsAssignment_2");
					put(grammarAccess.getBoardAccess().getFlowsAssignment_4(), "rule__Board__FlowsAssignment_4");
					put(grammarAccess.getInputPortAccess().getTypeAssignment_1(), "rule__InputPort__TypeAssignment_1");
					put(grammarAccess.getInputPortAccess().getNameAssignment_2(), "rule__InputPort__NameAssignment_2");
					put(grammarAccess.getOutputPortAccess().getErrorPortAssignment_0_0(), "rule__OutputPort__ErrorPortAssignment_0_0");
					put(grammarAccess.getOutputPortAccess().getTypeAssignment_1(), "rule__OutputPort__TypeAssignment_1");
					put(grammarAccess.getOutputPortAccess().getNameAssignment_2(), "rule__OutputPort__NameAssignment_2");
					put(grammarAccess.getFlowAccess().getFromAssignment_0(), "rule__Flow__FromAssignment_0");
					put(grammarAccess.getFlowAccess().getToAssignment_2(), "rule__Flow__ToAssignment_2");
					put(grammarAccess.getIntegratedPortAccess().getUnitAssignment_0(), "rule__IntegratedPort__UnitAssignment_0");
					put(grammarAccess.getIntegratedPortAccess().getPortAssignment_1(), "rule__IntegratedPort__PortAssignment_1");
					put(grammarAccess.getPortAccess().getNameAssignment_1(), "rule__Port__NameAssignment_1");
					put(grammarAccess.getLocalInputPortAccess().getPortAssignment_1(), "rule__LocalInputPort__PortAssignment_1");
					put(grammarAccess.getInputPortReferenceAccess().getClosureAssignment_2(), "rule__InputPortReference__ClosureAssignment_2");
					put(grammarAccess.getLocalOutputPortAccess().getPortAssignment_1(), "rule__LocalOutputPort__PortAssignment_1");
					put(grammarAccess.getUnitAccess().getNameAssignment_1(), "rule__Unit__NameAssignment_1");
					put(grammarAccess.getUnitAccess().getPortsAssignment_2(), "rule__Unit__PortsAssignment_2");
					put(grammarAccess.getUnitAccess().getDeclarationsAssignment_4(), "rule__Unit__DeclarationsAssignment_4");
					...
					put(grammarAccess.getConstructorAccess().getBodyAssignment_4(), "rule__Constructor__BodyAssignment_4");
					put(grammarAccess.getVariableDeclarationAccess().getVarDeclAssignment(), "rule__VariableDeclaration__VarDeclAssignment");
					put(grammarAccess.getInputProcessingDeclarationAccess().getInputPortAssignment_1(), "rule__InputProcessingDeclaration__InputPortAssignment_1");
					put(grammarAccess.getInputProcessingDeclarationAccess().getExprAssignment_2(), "rule__InputProcessingDeclaration__ExprAssignment_2");
					put(grammarAccess.getInputProcessingDeclarationAccess().getOutputPortAssignment_3_1(), "rule__InputProcessingDeclaration__OutputPortAssignment_3_1");
					put(grammarAccess.getMethodDeclarationAccess().getTypeAssignment_1(), "rule__MethodDeclaration__TypeAssignment_1");
					put(grammarAccess.getMethodDeclarationAccess().getNameAssignment_2(), "rule__MethodDeclaration__NameAssignment_2");
					put(grammarAccess.getMethodDeclarationAccess().getParamsAssignment_4_0(), "rule__MethodDeclaration__ParamsAssignment_4_0");
					put(grammarAccess.getMethodDeclarationAccess().getParamsAssignment_4_1_1(), "rule__MethodDeclaration__ParamsAssignment_4_1_1");
					put(grammarAccess.getMethodDeclarationAccess().getBodyAssignment_6(), "rule__MethodDeclaration__BodyAssignment_6");
					put(grammarAccess.getXExpressionAccess().getOutputPortAssignment_1_0_2(), "rule__XExpression__OutputPortAssignment_1_0_2");
					put(grammarAccess.getDataTypeAccess().getNameAssignment_1(), "rule__DataType__NameAssignment_1");
					put(grammarAccess.getDataTypeAccess().getTypeParametersAssignment_2_1(), "rule__DataType__TypeParametersAssignment_2_1");
					put(grammarAccess.getDataTypeAccess().getTypeParametersAssignment_2_2_1(), "rule__DataType__TypeParametersAssignment_2_2_1");
					put(grammarAccess.getDataTypeAccess().getExtendsAssignment_3_1(), "rule__DataType__ExtendsAssignment_3_1");
					put(grammarAccess.getDataTypeAccess().getImplementsAssignment_4_1(), "rule__DataType__ImplementsAssignment_4_1");
					put(grammarAccess.getDataTypeAccess().getImplementsAssignment_4_2_1(), "rule__DataType__ImplementsAssignment_4_2_1");
					put(grammarAccess.getDataTypeAccess().getMembersAssignment_6(), "rule__DataType__MembersAssignment_6");
					put(grammarAccess.getPropertyDeclarationAccess().getTypeAssignment_0(), "rule__PropertyDeclaration__TypeAssignment_0");
					put(grammarAccess.getPropertyDeclarationAccess().getNameAssignment_1(), "rule__PropertyDeclaration__NameAssignment_1");
					put(grammarAccess.getPropertyDeclarationAccess().getInitialValueAssignment_2_1(), "rule__PropertyDeclaration__InitialValueAssignment_2_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			de.gammarcraft.aqua.ui.contentassist.antlr.internal.InternalAquaParser typedParser = (de.gammarcraft.aqua.ui.contentassist.antlr.internal.InternalAquaParser) parser;
			typedParser.entryRuleAquaModel();
